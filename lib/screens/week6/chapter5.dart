  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: _play,
        tooltip: 'Play',
        child: _playing ? const Icon(Icons.square_rounded) : const Icon(Icons.play_circle, color: Colors.white,),
      ),
        appBar: AppBar(
          iconTheme: IconThemeData(color: Colors.white),
          centerTitle: true,
          title: const Text("Properties of Probability", style: TextStyle(color: Colors.white)),
