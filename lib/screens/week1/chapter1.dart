          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8.0),
                T_Body(
                    t: '       • ในทางคอมพิวเตอร์ คือการแทนข้อมูลด้วยเลขฐานสอง โดยมีค่าได้เพียงสองค่า คือ 0 หรือ 1 เท่านั้น'),
                SizedBox(height: 8.0),
                T_Body(
                    t: '       • สำหรับคอมพิวเตอร์ เลข 0 และ 1 มีความหมายที่พิเศษ ตัวอย่างเช่น \n         0 หมายถึง เท็จ และ 1 หมายถึง จริง \n         0 หมายถึง ปิด และ 1 หมายถึง เปิด \n         0 หมายถึง ต่ำ และ 1 หมายถึง สูง'),
                SizedBox(height: 8.0),
                ...
                SizedBox(height: 8.0),
                T_Body(
                    t: '       • การแทนข้อมูลด้วย Quick Response Code (QR Code)'),
                SizedBox(height: 8.0),
